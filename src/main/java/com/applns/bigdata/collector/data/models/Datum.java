...
public class Datum {
	...
	public String getMaterialId() {
		return getFirst254Chars(materialId);
	}
	...
	public String getMainReferenceNumber() {
		return getFirst254Chars(mainReferenceNumber);
	}
	...
	public String getDateDisplay() {
		return getFirst254Chars(dateDisplay);
	}
	...
	public String getArtistDisplay() {
		return getFirst254Chars(artistDisplay);
	}
	...
	public String getPlaceOfOrigin() {
		return getFirst254Chars(placeOfOrigin);
	}
	...
	public String getDescription() {
		return getFirst254Chars(description);
	}
	...
	public String getPublicationHistory() {
		return getFirst254Chars(publicationHistory);
	}
	...
	public String getExhibitionHistory() {
		return getFirst254Chars(exhibitionHistory);
	}
	...
	public String getProvenanceText() {
		return getFirst254Chars(provenanceText);
	}
	...
	public String getInscriptions() {
		return getFirst254Chars(inscriptions);
	}
	...
	public String getDimensions() {
		return getFirst254Chars(dimensions);
	}
	...
	public String getGalleryTitle() {
		return getFirst254Chars(galleryTitle);
	}
	...
	public String getArtworkTypeTitle() {
		return getFirst254Chars(artworkTypeTitle);
	}
	...
	public String getDepartmentTitle() {
		return getFirst254Chars(departmentTitle);
	}
	...
	public String getDepartmentId() {
		return getFirst254Chars(departmentId);
	}
	...
	public String getArtistTitle() {
		return getFirst254Chars(artistTitle);
	}
	...
	public String getStyleId() {
		return getFirst254Chars(styleId);
	}
	...
	public String getStyleTitle() {
		return getFirst254Chars(styleTitle);
	}
	...
	public String getClassificationId() {
		return getFirst254Chars(classificationId);
	}
	...
	public String getClassificationTitle() {
		return getFirst254Chars(classificationTitle);
	}
	...
	public String getSourceUpdatedAt() {
		return getFirst254Chars(sourceUpdatedAt);
	}
	...
	public String getUpdatedAt() {
		return getFirst254Chars(updatedAt);
	}
	...
	public String getTimestamp() {
		return getFirst254Chars(timestamp);
	}
	...
	public String getImageId() {
		return getFirst254Chars(imageId);
	}
	...
	private String getFirst254Chars(String input) {
		if (input != null) {
			return input.substring(0, Math.min(input.length(), 254));
		}
		return null;
	}
